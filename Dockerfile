...
##   $ docker build -t tomcat-for-mattlk13-jenkins-container .
##
## RUNNING
##   $ docker run -p 8080:8080 tomcat-for-mattlk13-jenkins-container
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="348knrl" \
    STACKSMITH_STACK_NAME="Tomcat for Mattlk13/jenkins-container" \
